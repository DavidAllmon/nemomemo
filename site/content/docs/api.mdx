...
cookie jar (see the [example](#example) below). Sessions last 30 days and slide on use.
Personal access tokens (`Authorization: Bearer …`) are on the
[roadmap](https://github.com/DavidAllmon/nemomemo/blob/main/docs/ROADMAP.md) but not
available yet.
